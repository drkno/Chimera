package nz.co.makereti.chimera.settings;
...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    public static class WiFiPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            bindPreferenceSummaryToValue(findPreference("garageSSIDTrigger"));
            bindPreferenceSummaryToValue(findPreference("wifiScanDelay"));

            final Preference clearNotification = findPreference("clearNotification");
            clearNotification.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                public boolean onPreferenceClick(Preference preference) {
                    NotificationManager notificationManger = (NotificationManager) preference.getContext().getSystemService(Context.NOTIFICATION_SERVICE);
                    notificationManger.cancel(InRangeService.SCANNING_NOTIFICATION);
                    return true;
                }
            });
        }
    ...
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class GaragePreferenceFragment extends PreferenceFragment {
        @Override
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
